    ...
    >
      <motion.header variants={item} className="mb-10 flex justify-between items-end">
        <div>
          ...
          <p className="text-on-surface-variant font-medium font-body">Welcome back, Administrator. Here's your Dampella LMS status.</p>
        </div>
            ...
            <div className="glass-card p-5 rounded-[1.5rem] shadow-sm border border-white/40">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-on-surface-variant mt-1 line-clamp-2 font-body">The Atelier board has released $2M in specialized grants for AI-driven pedagogical research...</p>
                </div>
              </div>
            </div>

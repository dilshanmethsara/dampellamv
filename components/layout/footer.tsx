    ...
    <footer className="relative bg-card overflow-hidden pt-24 pb-8 border-t border-border/50">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="pt-8 border-t border-border/50 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-background/50 border border-border/50 shadow-sm backdrop-blur-sm">
            <span className="text-muted-foreground text-[10px] uppercase tracking-widest font-medium">Project by</span>

      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="absolute -top-6 -left-4 md:-top-10 md:-left-8 opacity-[0.03] rotate-12 pointer-events-none">
              <Quote className="h-40 w-40 md:h-64 md:w-64 text-foreground" />
            </div>
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-10 md:gap-16 items-center md:items-start">
              ...
              >
                ...
                <div className="relative w-32 h-32 md:w-48 md:h-48 rounded-full bg-slate-100 dark:bg-slate-800 border-4 border-background shadow-2xl flex items-center justify-center overflow-hidden">
                  <User className="h-16 w-16 md:h-24 md:w-24 text-slate-400 dark:text-slate-600" />
                </div>
              </motion.div>

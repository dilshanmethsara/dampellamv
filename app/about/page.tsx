...
export default async function AboutPage() {
  ...
  const info = {
    ...
    fullName: settings?.full_name || schoolInfo.fullName,
    ...
    yearsOfExcellence: settings?.years_of_excellence || schoolInfo.yearsOfExcellence,
    principalName: settings?.principal_name || schoolInfo.principalName,
    principalMessage: settings?.principal_message || schoolInfo.principalMessage,
  ...
  return (
    <>
      ...
      <main className="pt-24">
        ...
        {/* Principal's Message */}
        <section id="principal-message" className="py-20 bg-muted/30 scroll-mt-24">
          <div className="container mx-auto px-4">
            <SectionHeader

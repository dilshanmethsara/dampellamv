...
const categoryColors: Record<string, string> = {
  announcement: "bg-[#1B2A6B]/10 text-[#1B2A6B] dark:text-[#9c9af4] border-[#1B2A6B]/20",
  "special-event": "bg-[#7C3AED]/10 text-[#7C3AED] dark:text-[#c3c0ff] border-[#7C3AED]/20",
  "upcoming-event": "bg-[#4F46E5]/10 text-[#4F46E5] dark:text-[#bfc2ff] border-[#4F46E5]/20",
  achievement: "bg-[#5B35D5]/10 text-[#5B35D5] dark:text-[#c3c0ff] border-[#5B35D5]/20",
  sports: "bg-[#9333EA]/10 text-[#9333EA] dark:text-[#c3c0ff] border-[#9333EA]/20",
  club: "bg-[#4B41E1]/10 text-[#4B41E1] dark:text-[#bfc2ff] border-[#4B41E1]/20",
}
                      ...
                      <div className="relative h-56 overflow-hidden">
                        ...
                        {announcement.featured && (
                          <div className="absolute top-4 right-4">
                            <Badge className="bg-gradient-to-r from-[#4F46E5] to-[#9333EA] text-white border-none shadow-lg gap-1.5 py-1 px-3">

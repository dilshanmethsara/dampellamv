...
const gradients = [
  { from: "from-[#1B2A6B]", to: "to-[#4F46E5]", glow: "group-hover:shadow-[0_0_30px_rgba(27,42,107,0.3)]", text: "group-hover:text-[#4F46E5]", bg: "bg-[#4F46E5]/10 text-[#4F46E5]" },
  { from: "from-[#4F46E5]", to: "to-[#7C3AED]", glow: "group-hover:shadow-[0_0_30px_rgba(79,70,229,0.3)]", text: "group-hover:text-[#7C3AED]", bg: "bg-[#7C3AED]/10 text-[#7C3AED]" },
  { from: "from-[#5B35D5]", to: "to-[#9333EA]", glow: "group-hover:shadow-[0_0_30px_rgba(91,53,213,0.3)]", text: "group-hover:text-[#9333EA]", bg: "bg-[#9333EA]/10 text-[#9333EA]" },
  { from: "from-[#9333EA]", to: "to-[#EC4899]", glow: "group-hover:shadow-[0_0_30px_rgba(147,51,234,0.3)]", text: "group-hover:text-[#9333EA]", bg: "bg-[#9333EA]/10 text-[#9333EA]" },
]
